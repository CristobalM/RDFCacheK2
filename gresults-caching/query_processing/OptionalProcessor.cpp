...
OptionalProcessor::OptionalProcessor(std::shared_ptr<ResultTable> left_table,
                                     std::shared_ptr<ResultTable> right_table)
    : left_table(std::move(left_table)), right_table(std::move(right_table)) {}

std::vector<unsigned long> OptionalProcessor::get_diff_list(
...
std::vector<unsigned long> OptionalProcessor::get_extra_cols(
...
OptionalProcessor::jmap_t OptionalProcessor::get_join_map(
...
std::set<unsigned long> OptionalProcessor::get_join_vars() const {
...
std::vector<unsigned long> OptionalProcessor::get_real_indexes(
...
void OptionalProcessor::select_values(
