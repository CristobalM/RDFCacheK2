...
template <BGPOp::VARS WV> class TwoVarJoinOneBGPOp : public BGPOp {
  ...
  std::unique_ptr<K2TreeMixed::K2TreeScanner> current_band_scanner;
  unsigned long current_band;
  K2TreeMixed::BandType current_band_type;

public:
  TwoVarJoinOneBGPOp(std::unique_ptr<K2TreeMixed::K2TreeScanner> &&scanner,
