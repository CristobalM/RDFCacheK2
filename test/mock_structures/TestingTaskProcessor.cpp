...
I_TRStreamer &
TestingTaskProcessor::create_triples_streamer(std::vector<unsigned long> &&loaded_predicates) {
    auto streamer = std::unique_ptr<TripleMatchesPartStreamer>(new TripleMatchesPartStreamer(
