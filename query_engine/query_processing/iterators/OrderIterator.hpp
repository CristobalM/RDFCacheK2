...
#ifndef RDFCACHEK2_ORDERITERATOR_HPP
#define RDFCACHEK2_ORDERITERATOR_HPP
...
class OrderIterator : public QueryIterator {
...
public:
  OrderIterator(const std::shared_ptr<QueryIterator> &input_it,
...
#endif // RDFCACHEK2_ORDERITERATOR_HPP
