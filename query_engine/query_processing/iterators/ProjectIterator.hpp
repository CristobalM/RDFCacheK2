...
#ifndef RDFCACHEK2_PROJECTITERATOR_HPP
#define RDFCACHEK2_PROJECTITERATOR_HPP

#include "QueryIterator.hpp"
#include <TimeControl.hpp>
#include <set>
class ProjectIterator : public QueryIterator {
...
public:
  ProjectIterator(std::shared_ptr<QueryIterator> input_it,
...
#endif // RDFCACHEK2_PROJECTITERATOR_HPP
