...
#ifndef RDFCACHEK2_FILTERITERATOR_HPP
#define RDFCACHEK2_FILTERITERATOR_HPP
...
public:
  FilterIterator(std::shared_ptr<QueryIterator> input_it, VarIndexManager &vim,
...
#endif // RDFCACHEK2_FILTERITERATOR_HPP
