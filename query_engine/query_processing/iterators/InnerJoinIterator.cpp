...
#include "InnerJoinIterator.hpp"
#include <query_processing/QueryProcessor.hpp>
bool InnerJoinIterator::has_next() { return next_available; }

std::vector<unsigned long> InnerJoinIterator::next() { return next_concrete(); }
std::vector<unsigned long> &InnerJoinIterator::get_headers() { return headers; }
void InnerJoinIterator::reset_iterator() {
...
InnerJoinIterator::InnerJoinIterator(
...
void InnerJoinIterator::build_headers(
...
bool InnerJoinIterator::create_var_binding_qproc_if_needed(
...
std::vector<unsigned long> InnerJoinIterator::next_concrete() {
  next_available = false;
...
InnerJoinIterator::get_pos_map(std::vector<unsigned long> &from,
...
void InnerJoinIterator::map_rows_to_holder(
