...
std::vector<unsigned long> ResultTableIteratorUnion::next() {
  return next_concrete();
}
std::vector<unsigned long> &ResultTableIteratorUnion::get_headers() {
  return headers;
}
void ResultTableIteratorUnion::reset_iterator() {
...
std::vector<unsigned long> ResultTableIteratorUnion::build_headers() {
...
ResultTableIteratorUnion::build_headers_mapping() {
...
ResultTableIteratorUnion::get_mapped_row(std::vector<unsigned long> &input_row,
                                         size_t it_pos) {
