...
public:
  ...
  virtual uint64_t blanks_index(std::string &blank) = 0;
  virtual uint64_t literals_index(std::string &literal) = 0;
  virtual uint64_t iris_index(std::string &iri) = 0;

  virtual bool has_blanks_index(std::string &blank) = 0;
  virtual bool has_literals_index(std::string &literal) = 0;
  virtual bool has_iris_index(std::string &iri) = 0;
