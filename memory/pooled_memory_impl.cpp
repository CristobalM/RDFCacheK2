...
struct u32array_alloc k2tree_alloc_u32array(int size){
  ...
  if(container_sz <= 32){
    out.data = (uint32_t *)MemoryManager::instance().containers_32.request_memory();
    out.size = 32;
    return out;
  }
  ...
  switch (container_sz){
    case 64:
      out.data = (uint32_t *)MemoryManager::instance().containers_64.request_memory();
      out.size = 64;
      break;
    case 128:
      out.data = (uint32_t *)MemoryManager::instance().containers_128.request_memory();
      out.size = 128;
      break;
    case 256:
      out.data = (uint32_t *)MemoryManager::instance().containers_256.request_memory();
      out.size = 256;
      break;
    case 512:
      out.data = (uint32_t *)MemoryManager::instance().containers_512.request_memory();
      out.size = 512;
      break;
    case 1024:
      out.data = (uint32_t *)MemoryManager::instance().containers_1024.request_memory();
      out.size = 1024;
      break;
    default:
      throw std::runtime_error("Invalid container_sz" + std::to_string(container_sz));
  }
...
int k2tree_free_u32array(struct u32array_alloc alloc){
  ...
  switch (alloc.size){
    case 64:
      ...
      break;
    case 128:
      MemoryManager::instance().containers_128.free_memory(reinterpret_cast<b128_t *>(alloc.data) );
      break;
    case 256:
      MemoryManager::instance().containers_256.free_memory(reinterpret_cast<b256_t *>(alloc.data) );
      break;
    case 512:
      MemoryManager::instance().containers_512.free_memory(reinterpret_cast<b512_t *>(alloc.data) );
      break;
    case 1024:
      MemoryManager::instance().containers_1024.free_memory(reinterpret_cast<b1024_t *>(alloc.data) );
      break;
    default:
      throw std::runtime_error("Invalid container_sz" + std::to_string(alloc.size));
  }
  return 0;
}
